...
const DropdownUser = () => {
  ...
  useEffect(() => {
    const storedNamaPegawai = localStorage.getItem("nama_pegawai");
  ...
  const handleLogout = () => {
    ...
    document.cookie =
      "cookie_login=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;";
    ...
    Swal.fire({
      ...
      // Redirect ke halaman root setelah swal ditutup
      router.push("/");
    });
  };
      ...
      >
        <span className="hidden text-right lg:block">
          <span className="block text-sm font-medium text-white dark:text-white">
            {namaPegawai ? `${namaPegawai}` : "Loading..."}
          </span>
        </span>
